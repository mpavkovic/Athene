                        ...
                        items: [
                            {
                                ...
                                handler: function(grid, rowIndex, columnIndex) {
                                    ...
                                    view.down('form').loadRecord(Ext.getStore('SlobodnaAktivnost').getAt(rowIndex));
                                    view.down('#formSlobodnaAktivnostSubmit').text = 'Spremi';
                                    view.title = 'Izmijeni: ' + Ext.getStore('SlobodnaAktivnost').getAt(rowIndex).data.naziv;
...
Ext.ComponentManager.registerType('slobodnaaktivnostlist', Athene.view.slobodnaaktivnost.List);